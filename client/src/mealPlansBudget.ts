...
export const MEDIUM_BUDGET_MAINTENANCE: MealPlan[] = [
  ...
  { id: 'med-w1-maint-wed', week: 1, day: 3, dayName: 'Wednesday', goal: 'maintenance', meals: {
    breakfast: { name: 'Turkey Bacon Omelette', description: '3-egg omelette with turkey bacon and vegetables', time: '7:00 AM', ingredients: ['3 eggs', '3 strips turkey bacon', 'Bell peppers', 'Onions', 'Cheese', 'Whole wheat toast'], instructions: ['Cook turkey bacon', 'Make omelette with veggies', 'Serve with toast'], macros: { calories: 420, protein: 32, carbs: 28, fats: 20 }, prepTime: 15, cookingSkill: 'intermediate', budget: 'medium', dietTags: ['halal', 'high-protein'] },
  ...
  { id: 'med-w1-maint-sun', week: 1, day: 7, dayName: 'Sunday', goal: 'maintenance', meals: {
    breakfast: { name: 'Halal Full English', description: 'Complete breakfast with turkey bacon, eggs, beans, tomato', time: '8:00 AM', ingredients: ['3 eggs', '3 turkey bacon strips', 'Baked beans', 'Grilled tomato', 'Mushrooms', 'Toast'], instructions: ['Cook all components', 'Arrange on plate'], macros: { calories: 480, protein: 34, carbs: 48, fats: 18 }, prepTime: 25, cookingSkill: 'intermediate', budget: 'medium', dietTags: ['halal', 'high-protein'] },
...
export const HIGH_BUDGET_MAINTENANCE: MealPlan[] = [
  ...
  { id: 'high-w1-maint-wed', week: 1, day: 3, dayName: 'Wednesday', goal: 'maintenance', meals: {
    ...
    afternoonSnack: { name: 'Prosciutto & Melon', description: 'Classic Italian appetizer', time: '4:00 PM', ingredients: ['3 oz prosciutto', 'Fresh cantaloupe', 'Balsamic glaze'], instructions: ['Wrap melon in prosciutto', 'Drizzle with balsamic'], macros: { calories: 200, protein: 18, carbs: 14, fats: 10 }, prepTime: 5, cookingSkill: 'beginner', budget: 'high', dietTags: ['halal', 'gluten-free', 'high-protein'] },
  ...
  { id: 'high-w1-maint-sat', week: 1, day: 6, dayName: 'Saturday', goal: 'maintenance', meals: {
    breakfast: { name: 'Eggs Benedict (Halal)', description: 'Classic eggs benedict with turkey bacon', time: '8:00 AM', ingredients: ['English muffin', '2 eggs', '4 strips turkey bacon', 'Hollandaise sauce', 'Asparagus'], instructions: ['Poach eggs perfectly', 'Make hollandaise', 'Assemble benedict'], macros: { calories: 480, protein: 28, carbs: 36, fats: 26 }, prepTime: 25, cookingSkill: 'advanced', budget: 'high', dietTags: ['halal', 'high-protein', 'gourmet'] },
    ...
    afternoonSnack: { name: 'Charcuterie Selection', description: 'Premium meats and cheeses', time: '4:00 PM', ingredients: ['Salami', 'Prosciutto', 'Aged cheddar', 'Olives', 'Crackers'], instructions: ['Arrange board'], macros: { calories: 280, protein: 18, carbs: 16, fats: 18 }, prepTime: 5, cookingSkill: 'beginner', budget: 'high', dietTags: ['halal', 'high-protein'] },
